...
# conn.commit()
# conn.close()
my_data = makemydata.MakeMyData('questions.db')
...
def submit():
    ...
    # Create the Text Box
    question = Entry(root, width=70, font=("맑은고딕", 30))
    question.grid(row=0, column=1, padx=20, pady=40)
    an1 = Entry(root, width=70, font=("맑은고딕", 30))
    an1.grid(row=1, column=1, padx=20)
    an2 = Entry(root, width=70, font=("맑은고딕", 30))
    an2.grid(row=2, column=1, padx=20)
    an3 = Entry(root, width=70, font=("맑은고딕", 30))
    an3.grid(row=3, column=1, padx=20)
    an4 = Entry(root, width=70, font=("맑은고딕", 30))
    an4.grid(row=4, column=1, padx=20)
    an5 = Entry(root, width=70, font=("맑은고딕", 30))
    an5.grid(row=5, column=1, padx=20)
    corr = Entry(root, width=70, font=("맑은고딕", 30))
    ...
    question_label = Label(root, text="문 제", font=("맑은고딕", 30))
    question_label.grid(row=0, column=0, pady=40)
    an1_label = Label(root, text="문항1", font=("맑은고딕", 30))
    an1_label.grid(row=1, column=0)
    an2_label = Label(root, text="문항2", font=("맑은고딕", 30))
    an2_label.grid(row=2, column=0)
    an3_label = Label(root, text="문항3", font=("맑은고딕", 30))
    an3_label.grid(row=3, column=0)
    an4_label = Label(root, text="문항4", font=("맑은고딕", 30))
    an4_label.grid(row=4, column=0)
    an5_label = Label(root, text="문항5", font=("맑은고딕", 30))
    ...
    my_data_insert = MakeInsertData('questions.db')
...
def query():
    ...
    def ask_question(records, question_idx, remain_question):
        ...
        query_label = Label(root, text=print_records, justify="left", padx=50, pady=50, font=("나눔명조체", 30))
        ...
        def enter_value(event):
            ...
            if str(content) == str(record[7]):
                ans_label = Label(root, text="맞았습니다.^^", font=("맑은고딕", 30))
                ans_label.grid(row=9, column=0)
                score += 1
            else:
                ans_label = Label(root, text="틀렸습니다.ㅠㅠ", font=("맑은고딕", 30))
                ans_label.grid(row=9, column=0)
        ...
        ent_ans_label = Label(root, text="정답 ", font=("맑은고딕", 30))
        ent_ans_label.grid(row=8, column=0)

        ent_ans = Entry(root, width=3, font=("맑은고딕", 30))
        ent_ans.focus_set()
        ent_ans.bind("<Return>", enter_value)
        ent_ans.grid(row=8, column=1)
...
def update():
    ...
    # Close Connection
    conn.close()
    response = messagebox.showinfo("문제수정", "문제가 수정되어 저장되었습니다.")
    return
    # editor.destroy()
...
def edit():
    ...
    # Create the Text Box
    question_editor = Entry(root, width=70, font=("맑은고딕", 30))
    question_editor.grid(row=0, column=1, padx=20, pady=40)
    an1_editor = Entry(root, width=70, font=("맑은고딕", 30))
    an1_editor.grid(row=1, column=1, padx=20, pady=5)
    an2_editor = Entry(root, width=70, font=("맑은고딕", 30))
    an2_editor.grid(row=2, column=1, padx=20, pady=5)
    an3_editor = Entry(root, width=70, font=("맑은고딕", 30))
    an3_editor.grid(row=3, column=1, padx=20, pady=5)
    an4_editor = Entry(root, width=70, font=("맑은고딕", 30))
    an4_editor.grid(row=4, column=1, padx=20, pady=5)
    an5_editor = Entry(root, width=70, font=("맑은고딕", 30))
    an5_editor.grid(row=5, column=1, padx=20, pady=5)
    corr_editor = Entry(root, width=70, font=("맑은고딕", 30))
    ...
    an5_label = Label(root, text="문항5", font=("맑은고딕", 30))
    an5_label.grid(row=5, column=0)
    corr_label = Label(root, text="정 답", font=("맑은고딕", 30))
    corr_label.grid(row=6, column=0)
    ...
    save_btn = Button(root, text="저장 하기", command=update, font=("맑은고딕", 30))
...
mk_question_btn = Button(root, text="문제 만들기", command=submit, padx=100, font=("맑은고딕", 30))
mk_question_btn.grid(row=0, column=0, pady=150)
mk_question_btn.place(relx=0.5, rely=0.1, anchor=CENTER)

question_btn = Button(root, text="문제 풀기", command=query, padx=105, font=("맑은고딕", 30))
question_btn.grid(row=1, column=0, pady=20)
question_btn.place(relx=0.5, rely=0.3, anchor=CENTER)

# Create a Delete Button
delete_btn = Button(root, text="문제 지우기", command=delete, padx=100, font=("맑은고딕", 30))
delete_btn.grid(row=2, column=0, pady=20)
delete_btn.place(relx=0.5, rely=0.5, anchor=CENTER)

# Create an Update Button
edit_btn = Button(root, text="수정 하기", command=edit, padx=105, font=("맑은고딕", 30))
edit_btn.grid(row=3, column=0, pady=20)
edit_btn.place(relx=0.5, rely=0.7, anchor=CENTER)

delete_box_label = Label(root, text="편집할 문제 번호를 먼저 선택하세요", font=("맑은고딕", 30))
delete_box_label.grid(row=13, column=0, padx=10)

delete_box = Entry(root, width=3, font=("맑은고딕", 30))
delete_box.grid(row=13, column=1, padx=5, pady=60)
delete_box.focus()
