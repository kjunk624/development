...
btn_add_file = Button(file_frame, background="yellow", padx=5, pady=5, width=12, text="화일 추가")
btn_add_file.pack(side="left")

btn_del_file = Button(file_frame, background="blue", padx=5, pady=5, width=12,text="선택 삭제")
